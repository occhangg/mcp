...
class TestSwitchProfileSigv4Region:
    @pytest.mark.asyncio
    @patch('awslabs.aws_transform_mcp_server.tools.configure.get_config', return_value=None)
    @patch('awslabs.aws_transform_mcp_server.tools.configure.is_sigv4_fes_available', return_value=True)
    @patch('awslabs.aws_transform_mcp_server.tools.configure.get_sigv4_regions', return_value=['us-east-1', 'eu-central-1'])
    ...
    async def test_select_valid_region(
        self, mock_set, mock_get_region, mock_get_regions, mock_available, mock_get_config, handler, mock_context
    ):
    ...
    async def test_select_invalid_region(
        self, mock_get_region, mock_get_regions, mock_available, mock_get_config, handler, mock_context
    ):
